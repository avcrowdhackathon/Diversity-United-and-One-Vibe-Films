...
<div class="post-header <?php echo esc_attr($sticky); ?>">
	<?php if ( has_post_thumbnail() ) : ?> 
		<a href="<?php echo esc_url(get_permalink()); ?>" class="post-images">
			<!-- <div> -->
				<img class="b-lazy" src="<?php echo veso_image_preloader($width,$height); ?>" height="<?php echo esc_attr($height);?>" width="<?php echo esc_attr($width); ?>" alt="" data-src="<?php echo esc_url($imgUrl); ?>" />
			<!-- </div> -->
		</a>
