 ...
 */
$el_class = $width = $el_id = $css = $offset = $overlay_color = $overlay_color_hover = $parallax = $parallax_speed = $parallax_content = $parallax_image = $show_on_hover = $show_on_hover_class = $text_color = $parallax_speed_bg = $parallax_bg_size = $gradient = $gradient_color = $gradient_bg = $gradient_opacity = '';
$output = '';
