...
<form method="get" class="search-form form-style veso-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
<div class="form-fieldset">
	<div class="veso-input">
	<label for="<?php echo esc_attr($unique_id); ?>">
		<span class="screen-reader-text"><?php echo esc_html_x( 'Search for:', 'label', 'veso' ); ?></span>
	</label>
